<div class="row my-4">
     ...
     <div class="col-12">
          <ol class="breadcrumb shadow-lg bg-white">
               ...
               <li class="breadcrumb-item"> <a href="#" class="px-md-3 px-1 active-1"> <?= str_replace("-"," ", $Path[1]); ?> </a> </li>
          </ol>
     </div>
...
<?php
     ...
     $SubCat3 = CategoriasController :: CtrGetPrdIdSC3($Param);

     if( is_array($SubCat3) )
     {
          $IdSubCat3 = $SubCat3["IdSubCat3"];
          $IdSubCat2 = $SubCat3["IdSubCat2"];
          $IdSubCat1 = $SubCat3["IdSubCat1"];
          $IdCat     = $SubCat3["IdCat"];
     ...
     else
     {
          ...
          $SubCat2 = CategoriasController :: CtrGetPrdIdSC2($Param);

          if( is_array($SubCat2) )
          {

               $IdSubCat3 = 0;
               $IdSubCat2 = $SubCat2["IdSubCat2"];
               $IdSubCat1 = $SubCat2["IdSubCat1"];
               $IdCat     = $SubCat2["IdCat"];
          ...
          else
          {
               ...
               $SubCat1 = CategoriasController :: CtrGetPrdIdSC1($Param);

               $IdSubCat3 = 0;
               $IdSubCat2 = 0;
               $IdSubCat1 = $SubCat1["IdSubCat1"];
               $IdCat     = $SubCat1["IdCat"];
     ...
     $TotProds  = ProductosController :: CtrTotProds($IdCat, $IdSubCat1, $IdSubCat2, $IdSubCat3);
     $Productos = ProductosController :: CtrProductos($IdCat, $IdSubCat1, $IdSubCat2, $IdSubCat3, $StartFrom, $Limit);
